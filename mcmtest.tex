...
\subsection{Analysis \& Results}
  ...
  \end{itemize}
  %========================================================================================================================
  We simulate some ``users'' and input their requests (available time, preference of POIs, etc.) to our PTPs and generate personalized tour plans for them. For example, a hypothetical user (who is enthusiastic about history and statues) inputs a preference $\vv{prf}$ = $[3, 1, 4, 5, 2]$. The tour plan PTPs offers is presented in table\ref{fig:table}.
  \begin{figure}[ht]
    \centering
  ...
  \begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{satscore.png}
